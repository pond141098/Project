$(function () {
    ...
    $.get("/Office/getJob", function (JsonResult) {
        setTimeout(function () {
            ...
            $("#JsonData").on("click", ".delete", function (e) {
                ...
                $.SmartMessageBox({
                    ...
                    if (ButtonPressed == "ใช่") {
                        $.get("/Office/DeleteJob", { "transaction_job_id": Id }, function (response) {
            ...
            $("#JsonData").on("click", ".edit", function () {
                window.location.href = "/Office/FormEditJob?transaction_job_id=" + $(this).val();
            });
    ...
    // add data
    $("#Add").click(function () {
        window.location.href = "/Office/FormAddJob";
    });
