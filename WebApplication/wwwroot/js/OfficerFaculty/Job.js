$(function () {
    ...
    $.get("/OfficerFaculty/getJob", function (JsonResult) {
        setTimeout(function () {
            ...
            $("#JsonData").on("click", ".delete", function (e) {
                ...
                $.SmartMessageBox({
                    ...
                    if (ButtonPressed == "ใช่") {
                        $.get("/OfficerFaculty/DeleteJob", { "transaction_job_id": Id }, function (response) {
                            if (response.valid == true) {
                                ...
                                setTimeout(function () {
                                    window.location.href = "/OfficerFaculty/Job";
                                }, 1000)
                            } else {
                                $.smallBox({
                                    title: response.message,
            ...
            $("#JsonData").on("click", ".edit", function () {
                window.location.href = "/OfficerFaculty/FormEditJob?transaction_job_id=" + $(this).val();
            });
    ...
    // add data
    $("#Add").click(function () {
        window.location.href = "/OfficerFaculty/FormAddJob";
    });
